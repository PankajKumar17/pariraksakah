...
- Hackathon Demo Console is visible
...
7. Click `Trigger Incident Response`.
...
3. Run `Launch Threat Wave` and narrate detection, campaign linkage, and visibility.
4. Open Threat Hunting and explain that it is a guided analyst workspace for campaign interpretation after detection.
5. Run `Run Phishing Scenario` and explain layered phishing and social-engineering analysis.
...
- If the live alert feed is quiet, run `Launch Threat Wave` again.
