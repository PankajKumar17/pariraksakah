  ...
  return (
    <BrowserRouter>
      <div className={`min-h-screen ${darkMode ? 'bg-[#0F172A] text-gray-100' : 'bg-gray-50 text-gray-900'}`}>
        {/* Top Nav */}
        <nav className="flex items-center justify-between px-6 py-3 border-b border-gray-700/50 bg-[#0F172A]/90 backdrop-blur">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold tracking-tight">Parirakṣakaḥ</span>
          </div>
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <span className="text-gray-500">{wsConnected ? 'Live' : 'Offline'}</span>
          </div>
        </nav>
